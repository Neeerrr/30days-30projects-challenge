...
# Modules - pygame, sys
# 
# Controls - Arrow Keys for Player 2(Yellow) and WASD Keys for Player 1(Red), Restart - (R) key and for Quit/close the game (Q) Key
# Made by Neeraj Ratstogi
# -----------------------------------------------------------------------------
...
def gameOver(number):
    while True:
        ...
        if number == 0:
            ...
            text = font.render("Player %d Lost the Game:(" %(number), True, white)
...
def tron():
    ...
    bike1 = tronBike(1, lightpink, pink, 0)
    bike2 = tronBike(2, cyan, Darkcyan, width)
